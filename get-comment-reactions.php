<?php
// Batch reaction lookup for every comment on a task, so the client makes
// one request instead of one per comment. Writer-side; see
// sudo/get-comment-reactions.php for the admin twin.
