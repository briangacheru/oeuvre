...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>itasker | Privacy Policy</title>
            ...
            <div class="col-sm-11 col-md-10 col-lg-8 col-xxl-7">
                ...
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <p class="text-600 mb-4">Last updated: <?= $legalPrivacy['updated_at'] ? date('F j, Y', strtotime($legalPrivacy['updated_at'])) : date('F j, Y') ?></p>

                        <?= $legalPrivacy['content'] ?>

                        <hr class="my-4" />
                        <p class="text-600 fs-10">See also our <a href="terms">Terms of Service</a>.</p>
