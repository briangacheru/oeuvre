                                            ...
                                            <td>
                                                <div class="d-flex align-items-center position-relative">
                                                    <div class="flex-1">
                                                        ...
                                                        <p class="fw-semi-bold mb-0 text-500"><?php echo htmlspecialchars($row["subject"], ENT_QUOTES, 'UTF-8'); ?> |<?php echo $row["pages"];?> | <?php echo $row["cpp"];?></p>
                                                    </div>
                                                </div>
                                            </td>
            ...
            (function() {
                ...
                if (modalEl) {
                    modalEl.addEventListener('show.bs.modal', function() {
                        ...
                        if (countEl) {
                            var checkedBoxes = document.querySelectorAll('input[data-bulk-select-row]:checked');
