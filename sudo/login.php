                        ...
                        <div class="row g-0 h-100">
                            <div class="col-md-5 text-center bg-card-gradient">
                                <div class="position-relative p-4 pt-md-5 pb-md-7" data-bs-theme="light">
                                    ...
                                    <div class="z-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-5 d-inline-flex align-items-center fw-bolder" href="<?php echo $base_path; ?>/index"><img class="me-2" src="../assets/img/icons/spot-illustrations/itasker.png" alt="" width="28" />iTasker</a>
...
<?= csrf_field() ?>
                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-12"><a class="btn btn-outline-google-plus btn-sm d-block w-100" href="google-login.php<?= isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : '' ?>"><span class="fab fa-google me-2" data-fa-transform="grow-8"></span> Sign in with Google</a></div>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
