...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['resend'])) {
        if (!check_rate_limit($con, 'otp_resend_writer', $pendingEmail, 3, 600)) {
            $verifyError = "
                <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                    <i class='bi bi-exclamation-circle me-1'></i> " . rate_limit_message($con, 'otp_resend_writer', $pendingEmail, 600, 'code resends') . "
